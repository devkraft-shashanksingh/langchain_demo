...
st.markdown("Upload a PDF document and start ask your questions on the content.")
...
def create_retrieval_chain(docs):
...
if uploaded_file and (not st.session_state.processed_docs or uploaded_file.name != st.session_state.uploaded_file_name):
    ...
    with st.spinner("Processing your PDF..."):
        ...
        st.session_state.retrieval_chain, st.session_state.retriever = create_retrieval_chain(st.session_state.processed_docs)
